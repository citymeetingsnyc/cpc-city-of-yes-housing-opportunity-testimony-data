...
This will generated `extracted-data.json` in your current directory.
...
See `analyze.py` for examples of this.
...
- Changes that make it easier to access the data in some way (e.g. some DuckDB SQL queries for folks who don't want to write Python).
- Code that illustrates how to use LLMs to analyze the data in another way.

If you have other ideas, contact me at [vikram@citymeetings.nyc](mailto:vikram@citymeetings.nyc).
